      ...
      <Stack direction="column" justifyContent="space-between" sx={{ height, paddingBottom: "64px" }}>
        <Box justifyContent="space-between" gap={8} flexDirection="column" sx={{ display: "flex" }}>
          <Stack direction="column">
            <ListItemButtonStyled selected={selectedIndex === 0} onClick={() => handleListItemClick(0)}>
              <ListItemIcon>
                <HomeIcon sx={{ color: "hsl(var(--icon-color))" }} />
              </ListItemIcon>
              <ListItemText primary="Dashboard" />
            </ListItemButtonStyled>
            <ListItemButtonStyled selected={selectedIndex === 1} onClick={() => handleListItemClick(1)}>
              <ListItemIcon>
                <BarChartIcon sx={{ color: "hsl(var(--icon-color))" }} />
              </ListItemIcon>
              <ListItemText primary="Tables" />
            </ListItemButtonStyled>
            <ListItemButtonStyled selected={selectedIndex === 2} onClick={() => handleListItemClick(2)}>
              <ListItemIcon>
                <PaymentIcon sx={{ color: "hsl(var(--icon-color))" }} />
              </ListItemIcon>
              <ListItemText primary="Billing" />
            </ListItemButtonStyled>
            <ListItemButtonStyled selected={selectedIndex === 3} onClick={() => handleListItemClick(3)}>
              <ListItemIcon>
        ...
        <Card sx={{ backgroundColor: isDarkMode ? "hsl(var(--foreground))" : "hsl(var(--foreground))" }}>
          <CardContent sx={{ borderRadius: "12px" }}>
            ...
            <Typography variant="h5" sx={{ color: "hsl(var(--title))" }}>
              Need help?
            </Typography>
            <Typography sx={{ color: "hsl(var(--title))" }}>Please check our docs</Typography>
