  ...
  return (
    <Stack
      ...
      <Box sx={{ maxWidth: 400, height: "100%", display: "flex", flexDirection: "column", justifyContent: "start" }}>
        <Typography sx={{ color: "hsl(var(--subTitle))", size: "14px" }}>Built by developers</Typography>
      ...
      <Box
        ...
        ref={wrapperRef}>
        <img
          style={{ width: "450px", height: "100%", borderRadius: "12px", userSelect: "none", pointerEvents: "none" }}
          src="/mui-dashboard.jpg"
          alt="mui-dashboard.jpg"
        />
        ...
        <Box
          sx={{
            ...
            width: "450px",
            height: "100%",
            backgroundImage: 'url("/business-communication.jpg")',
          ...
          <Box
            ...
            <Box>
              ...
              <Typography
                sx={{ color: "hsl(var(--subTitle))", maxWidth: "350px", fontSize: "14px", userSelect: "none" }}>
            ...
            <Button
              sx={{
                ...
                size: "14px",
                textTransform: "none",
                "&:hover": { backgroundColor: "transparent", transform: "translateX(5px)" },
              }}>
              Read more&nbsp;
              <ArrowRightAltIcon />
            </Button>
