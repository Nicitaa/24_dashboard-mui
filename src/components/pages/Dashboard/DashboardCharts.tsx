...
import { ResponsiveChartContainer, LinePlot, ChartsYAxis, useDrawingArea, useYScale } from "@mui/x-charts"
    ...
    <Stack>
      <ResponsiveChartContainer
        ...
        series={[
          ...
          {
            type: "line",
            data: [50134, 48361, 46362, 44826, 42376, 40168, 38264, 36159, 34259, 32168],
